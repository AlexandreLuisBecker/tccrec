...
while (True):
    ...
    imagemCinza = cv2.flip(imagemCinza, 180)
    faces = face_cascade.detectMultiScale(imagemCinza, minNeighbors=20, minSize=(30, 30), maxSize=(400, 400))
    for (x, y, w, h) in faces:
        ...
        for (ox, oy, ow, oh) in eyeDetected:
            cv2.rectangle(region, (ox, oy), (ox + ow, oy + oh), (255, 255, 0), 2)
